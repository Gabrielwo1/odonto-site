...
<nav id="nav">
  <div class="nav-w">
    ...
    <ul class="nav-links">
      ...
      <li><a href="index.html#structure">Estrutura</a></li>
      <li><a href="index.html#infra">Galeria</a></li>
    ...
    <div class="footer-top">
      ...
      <div>
        ...
        <ul class="footer-links">
          <li><a href="curso-harmonizacao.html">Ortodontia de Elite</a></li>
          <li><a href="curso-harmonizacao.html">Implantodontia Avançada</a></li>
          <li><a href="curso-harmonizacao.html">Endodontia Microscópica</a></li>
          <li><a href="cursos.html">Cursos Livres</a></li>
        </ul>
      </div>
      <div>
        <p class="footer-col-title">A Instituição</p>
        <ul class="footer-links">
          <li><a href="index.html#structure">Sobre Nós</a></li>
          <li><a href="index.html#structure">Corpo Docente</a></li>
          <li><a href="index.html#structure">Estrutura Clínica</a></li>
      ...
      <div>
        ...
        <ul class="footer-links">
          <li><a href="contato.html">FAQ</a></li>
